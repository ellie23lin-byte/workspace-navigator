        ...
        const initSortable = (ref) => {
            if (ref.current) {
                Sortable.create(ref.current, {
                    ...
                    onEnd: () => lucide.createIcons()
                });
            }
        };

        initSortable(aiRef);
        initSortable(workflowRef);
        initSortable(mediaRef);
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
                    ...
                    <section id="ai-tools" className="lg:col-span-8 scroll-mt-24">
                        ...
                        <div ref={aiRef} className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            {aiTools.map((tool) => (
                                <div key={tool.id} className="group relative cursor-grab active:cursor-grabbing p-5 bg-white border border-stone-200 rounded-[2rem] hover:shadow-xl transition-all duration-300">
                                    <div className="flex items-center space-x-4">
                        ...
                        <section id="productivity-tools" className="scroll-mt-24">
                            ...
                            <div ref={workflowRef} className="grid grid-cols-2 gap-3">
                                {workflowTools.map((tool) => (
                                    <div key={tool.id} className="cursor-grab active:cursor-grabbing">
