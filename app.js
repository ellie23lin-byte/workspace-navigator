...
const App = () => {
    ...
    const initialData = {
        ...
        media: [
            ...
            { id: 'md-2', name: 'Canva', url: 'https://www.capcut.com', color: 'bg-fuchsia-50' },
        ...
        const init = (type, setFunc) => {
            ...
            const ins = Sortable.create(el, {
                ...
                onEnd: (evt) => {
                    ...
                    // 關鍵：將 DOM 節點手動移回原處，讓 React 掌控渲染
                    const children = Array.from(from.children);
                    // 恢復 SortableJS 對 DOM 的改動
                ...
                <div className="max-w-[1600px] mx-auto px-8 py-4 flex justify-between items-center">
                    <div className="flex items-center space-x-10">
                        <div className="flex items-center space-x-3 cursor-pointer" onClick={() => window.scrollTo({top:0, behavior:'smooth'})}>
                            ...
                            <h1 className="text-xl font-bold text-stone-700 tracking-tight hidden
